<div class="mb-6 flex space-x-4 border-b border-zinc-200 dark:border-zinc-700">
    <a href="{{ route('settings.profile') }}" @class([
        'border-b-2 px-1 pb-4 text-sm font-medium',
        'border-primary-600 text-primary-600' => request()->routeIs('settings.profile'),
    ...
    <a href="{{ route('settings.appearance') }}" @class([
        'border-b-2 px-1 pb-4 text-sm font-medium',
        'border-primary-600 text-primary-600' => request()->routeIs('settings.appearance'),
    ...
    <a href="{{ route('settings.password') }}" @class([
        'border-b-2 px-1 pb-4 text-sm font-medium',
        'border-primary-600 text-primary-600' => request()->routeIs('settings.password'),
    ...
    <a href="{{ route('settings.integrations.tempo') }}" @class([
        'border-b-2 px-1 pb-4 text-sm font-medium',
        'border-primary-600 text-primary-600' => request()->routeIs('settings.integrations.tempo'),
    ...
    <a href="{{ route('settings.integrations.jira') }}" @class([
        'border-b-2 px-1 pb-4 text-sm font-medium',
        'border-primary-600 text-primary-600' => request()->routeIs('settings.integrations.jira'),
